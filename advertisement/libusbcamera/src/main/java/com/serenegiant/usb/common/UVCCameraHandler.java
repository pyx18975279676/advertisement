...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent, cameraView, 1, width, height, UVCCamera.FRAME_FORMAT_MJPEG, bandwidthFactor, null);
	}
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent, cameraView, encoderType, width, height, format, UVCCamera.DEFAULT_BANDWIDTH, null);
	}
	...
	public static final UVCCameraHandler createHandler(
			final Activity parent, final CameraViewInterface cameraView,
			final int encoderType, final int width, final int height, final int format, final float bandwidthFactor, OnPreViewResultListener preViewResultListener) {
		...
		thread.setPreViewResultListener(preViewResultListener);
		thread.start();
