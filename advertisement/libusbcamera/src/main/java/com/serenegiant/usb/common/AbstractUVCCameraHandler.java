...
//	}
	...
	public void startPreview(final Object surface) {
		checkReleased();
		if (surface != null && !((surface instanceof SurfaceHolder) || (surface instanceof Surface) || (surface instanceof SurfaceTexture))) {
...
//		private boolean isAudioThreadStart;
		...
		private OnPreViewResultListener preViewResultListener;

		public void setPreViewResultListener(OnPreViewResultListener preViewResultListener) {
			this.preViewResultListener = preViewResultListener;
		}
...
//				mUVCCamera.setFrameCallback(mIFrameCallback, UVCCamera.PIXEL_FORMAT_NV21);
		...
		public void handleCaptureStill(final String path) {
			...
			if (parent == null || mWeakCameraView == null) return;
...
//				}
				...
				if(preViewResultListener != null) {
					preViewResultListener.onPreviewResult(yuv);
				}
				// 捕获图片
